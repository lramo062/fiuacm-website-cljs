...
var len__25865__auto___38586 = arguments.length;
var i__25866__auto___38587 = (0);
while(true){
if((i__25866__auto___38587 < len__25865__auto___38586)){
args__25872__auto__.push((arguments[i__25866__auto___38587]));

var G__38588 = (i__25866__auto___38587 + (1));
i__25866__auto___38587 = G__38588;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__25873__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq38583){
var G__38584 = cljs.core.first.call(null,seq38583);
var seq38583__$1 = cljs.core.next.call(null,seq38583);
var G__38585 = cljs.core.first.call(null,seq38583__$1);
var seq38583__$2 = cljs.core.next.call(null,seq38583__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__38584,G__38585,seq38583__$2);
});
...
if(cljs.core.truth_((function (){var or__24790__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__25396__auto__,writer__25397__auto__,opt__25398__auto__){
return cljs.core._write.call(null,writer__25397__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__24778__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__24778__auto__){
var or__24790__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__24790__auto__)){
return or__24790__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__38589_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__38589_SHARP_));
})))){
...
var map__38598 = opts;
var map__38598__$1 = ((((!((map__38598 == null)))?((((map__38598.cljs$lang$protocol_mask$partition0$ & (64))) || (map__38598.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__38598):map__38598);
var markup_db = cljs.core.get.call(null,map__38598__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__24790__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e38602){var e__36198__auto__ = e38602;
return false;
}})();
if(cljs.core.truth_(or__24790__auto__)){
return or__24790__auto__;
...
}catch (e38604){var e__36198__auto__ = e38604;
return false;
}}
})())){
...
var _STAR_current_state_STAR_38609 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__38610 = opts;
var map__38610__$1 = ((((!((map__38610 == null)))?((((map__38610.cljs$lang$protocol_mask$partition0$ & (64))) || (map__38610.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__38610):map__38610);
var markup_db = cljs.core.get.call(null,map__38610__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_38609;
}});
...
;
var temp__4655__auto___38615 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___38615)){
var managed_print_level_38616 = temp__4655__auto___38615;
var _STAR_print_level_STAR_38614_38617 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_38616;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_38614_38617,managed_print_level_38616,temp__4655__auto___38615,writer,opts,job_fn){
return (function (p1__38612_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__38612_SHARP_,null);
});})(_STAR_print_level_STAR_38614_38617,managed_print_level_38616,temp__4655__auto___38615,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_38614_38617;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1484718753665