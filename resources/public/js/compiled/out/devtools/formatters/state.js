...
var len__25865__auto___38577 = arguments.length;
var i__25866__auto___38578 = (0);
while(true){
if((i__25866__auto___38578 < len__25865__auto___38577)){
args__25872__auto__.push((arguments[i__25866__auto___38578]));

var G__38579 = (i__25866__auto___38578 + (1));
i__25866__auto___38578 = G__38579;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__25873__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq38575){
var G__38576 = cljs.core.first.call(null,seq38575);
var seq38575__$1 = cljs.core.next.call(null,seq38575);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__38576,seq38575__$1);
});
...
return (function (p1__38580_SHARP_){
return (p1__38580_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1484718753549