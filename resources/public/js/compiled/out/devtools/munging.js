...
var o__36173__auto__ = (function (){var temp__4657__auto__ = goog.object.get(window,"cljs");
if(cljs.core.truth_(temp__4657__auto__)){
var o__36185__auto__ = temp__4657__auto__;
return goog.object.get(o__36185__auto__,"core");
} else {
return null;
}
})();
return goog.object.get(o__36173__auto__,"js_reserved_QMARK_").call(o__36173__auto__,x);
});
devtools.munging.get_fn_source_safely = (function devtools$munging$get_fn_source_safely(f){
try{var o__36173__auto__ = f;
return goog.object.get(o__36173__auto__,"toString").call(o__36173__auto__);
}catch (e38399){var _ = e38399;
return "";
}});
...
try{var o__36173__auto___38402 = t;
goog.object.get(o__36173__auto___38402,"cljs$lang$ctorPrWriter").call(o__36173__auto___38402,t,writer);
}catch (e38401){var __38403 = e38401;
}
...
var char_code = (function (){var o__36173__auto__ = (new String(char$));
return goog.object.get(o__36173__auto__,"charCodeAt").call(o__36173__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__36173__auto__ = String;
return goog.object.get(o__36173__auto__,"fromCharCode").call(o__36173__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__38405 = num_code;
switch (G__38405) {
case (1):
return (185);
...
var o__36173__auto__ = String;
return goog.object.get(o__36173__auto__,"fromCharCode").call(o__36173__auto__,superscript_code);
});
/**
...
}catch (e38411){var e__36198__auto__ = e38411;
return false;
}})())){
...
var vec__38412 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__38412,(0),null);
...
var or__24790__auto__ = (function (){var temp__4655__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__4655__auto__)){
...
var temp__4657__auto____$1 = goog.object.get(o__36186__auto__,"dependencies_");
if(cljs.core.truth_(temp__4657__auto____$1)){
var o__36185__auto__ = temp__4657__auto____$1;
return goog.object.get(o__36185__auto__,"nameToPath");
} else {
return null;
}
} else {
...
var len__25865__auto___38421 = arguments.length;
var i__25866__auto___38422 = (0);
while(true){
if((i__25866__auto___38422 < len__25865__auto___38421)){
args__25872__auto__.push((arguments[i__25866__auto___38422]));

var G__38423 = (i__25866__auto___38422 + (1));
i__25866__auto___38422 = G__38423;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__25873__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__38417){
var vec__38418 = p__38417;
var ns_detector = cljs.core.nth.call(null,vec__38418,(0),null);
var effective_detector = (function (){var or__24790__auto__ = ns_detector;
if(cljs.core.truth_(or__24790__auto__)){
return or__24790__auto__;
} else {
...
var G__38424 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__38425 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__38424;
remaining_tokens = G__38425;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq38415){
var G__38416 = cljs.core.first.call(null,seq38415);
var seq38415__$1 = cljs.core.next.call(null,seq38415);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__38416,seq38415__$1);
});
...
break;
default:
var o__36173__auto__ = window;
return goog.object.get(o__36173__auto__,"parseInt").call(o__36173__auto__,arity,(10));
...
var vec__38433 = cljs.core.split_with.call(null,(function (p1__38429_SHARP_){
return cljs.core.not_EQ_.call(null,p1__38429_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__38433,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__38433,(1),null);
...
var vec__38439 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__38439,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__38439,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__38442 = cljs.core.rest.call(null,remaining_tokens);
var G__38443 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__38442;
name_tokens = G__38443;
continue;
} else {
...
var args38444 = [];
var len__25865__auto___38456 = arguments.length;
var i__25866__auto___38457 = (0);
while(true){
if((i__25866__auto___38457 < len__25865__auto___38456)){
args38444.push((arguments[i__25866__auto___38457]));

var G__38458 = (i__25866__auto___38457 + (1));
i__25866__auto___38457 = G__38458;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args38444.length)].join('')));
...
var vec__38447 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__38447,(0),null);
var arity = cljs.core.nth.call(null,vec__38447,(1),null);
var vec__38450 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__38450,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__38450,(1),null);
var vec__38453 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__38453,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__38453,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__38453,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__38453,(3),null);
...
var args38460 = [];
var len__25865__auto___38466 = arguments.length;
var i__25866__auto___38467 = (0);
while(true){
if((i__25866__auto___38467 < len__25865__auto___38466)){
args38460.push((arguments[i__25866__auto___38467]));

var G__38468 = (i__25866__auto___38467 + (1));
i__25866__auto___38467 = G__38468;
continue;
} else {
}
break;
...
var vec__38463 = result;
var munged_ns = cljs.core.nth.call(null,vec__38463,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__38463,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__38463,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__38463,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__38463,(4),null);
var arity = cljs.core.nth.call(null,vec__38463,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__38476 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__38476,(0),null);
var args = cljs.core.nth.call(null,vec__38476,(1),null);
var vec__38479 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__38479,(0),null);
var name = cljs.core.nth.call(null,vec__38479,(1),null);
...
var G__38482 = (arity + (1));
var G__38483 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__38484){
var vec__38488 = p__38484;
var arity = cljs.core.nth.call(null,vec__38488,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__38488,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__24790__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__24790__auto__)){
return or__24790__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__38491_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__38492_SHARP_);
...
var args__25872__auto__ = [];
var len__25865__auto___38499 = arguments.length;
var i__25866__auto___38500 = (0);
while(true){
if((i__25866__auto___38500 < len__25865__auto___38499)){
args__25872__auto__.push((arguments[i__25866__auto___38500]));

var G__38501 = (i__25866__auto___38500 + (1));
i__25866__auto___38500 = G__38501;
continue;
} else {
}
break;
...
var argseq__25873__auto__ = ((((1) < args__25872__auto__.length))?(new cljs.core.IndexedSeq(args__25872__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__25873__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__38495){
var vec__38496 = p__38495;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__38496,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq38493){
var G__38494 = cljs.core.first.call(null,seq38493);
var seq38493__$1 = cljs.core.next.call(null,seq38493);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__38494,seq38493__$1);
});
...
var G__38503 = (((arg instanceof cljs.core.Keyword))?arg.fqn:null);
switch (G__38503) {
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__24790__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__24790__auto__)){
return or__24790__auto__;
} else {
...
return [cljs.core.str((cljs.core.truth_((function (){var and__24778__auto__ = include_ns_QMARK_;
...
return [cljs.core.str((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str(protocol_name)].join(''):null)),cljs.core.str(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str((cljs.core.truth_((function (){var or__24790__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__24790__auto__)){
return or__24790__auto__;
} else {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__38510__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__38510__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__38510__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__38510__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__38511 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__38511,(0),null);
var fn_name = cljs.core.nth.call(null,vec__38511,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__38511,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__38511,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__38511,(4),null);
var arity = cljs.core.nth.call(null,vec__38511,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__24778__auto__ = protocol_ns;
if(cljs.core.truth_(and__24778__auto__)){
return cljs.core.not.call(null,(function (){var and__24778__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str((function (){var or__24790__auto__ = protocol_part;
if(cljs.core.truth_(or__24790__auto__)){
return or__24790__auto__;
} else {
return fn_part;
...
var o__36173__auto__ = f;
return goog.object.get(o__36173__auto__,"getBasis").call(o__36173__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__24778__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__24778__auto__)){
...
}catch (e38516){var e__36198__auto__ = e38516;
...
var G__38517 = goog.object.get(obj,cljs.core.first.call(null,path));
var G__38518 = cljs.core.rest.call(null,path);
obj = G__38517;
path = G__38518;
continue;
} else {
...
var partition_bits = (function (){var or__24790__auto__ = goog.object.get(obj,partition_key);
if(cljs.core.truth_(or__24790__auto__)){
return or__24790__auto__;
} else {
return (0);
...
return (function (accum,p__38523){
var vec__38524 = p__38523;
var bit = cljs.core.nth.call(null,vec__38524,(0),null);
var protocol = cljs.core.nth.call(null,vec__38524,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__38527){
var vec__38531 = p__38527;
var ns = cljs.core.nth.call(null,vec__38531,(0),null);
var name = cljs.core.nth.call(null,vec__38531,(1),null);
var selector = cljs.core.nth.call(null,vec__38531,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__38540,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__38540,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__38540,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__38534_SHARP_){
return goog.object.get(obj,cljs.core.first.call(null,p1__38534_SHARP_));
});})(name,sorted_matches,vec__38540,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1484718753420